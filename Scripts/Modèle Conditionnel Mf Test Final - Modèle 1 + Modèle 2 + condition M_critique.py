...
df = pd.read_excel("D:/Mémoire ULB 2024-2025/1 - Avancées Travail Personnel/Machine Learning Final/XGBoost Mf V2/Modèle 2/Resultats_XGBoost_Mf_Modele2_CV.xlsx", sheet_name="Prédictions Test Final")
df2 = pd.read_excel("D:/Mémoire ULB 2024-2025/1 - Avancées Travail Personnel/Machine Learning Final/XGBoost Mf V2/Modèle 2/Resultats_XGBoost_Mf_Modele2_CV.xlsx", sheet_name="Prédictions Train-Test")
...
df_boot_1 = pd.read_excel("D:/Mémoire ULB 2024-2025/1 - Avancées Travail Personnel/Machine Learning Final/XGBoost Mf V2/Modèle 1/Resultats_XGBoost_Mf_Modele1_CV.xlsx", sheet_name="Prédictions Test Final")
df_boot_2 = pd.read_excel("D:/Mémoire ULB 2024-2025/1 - Avancées Travail Personnel/Machine Learning Final/XGBoost Mf V2/Modèle 2/Resultats_XGBoost_Mf_Modele2_CV.xlsx", sheet_name="Prédictions Test Final")
...
plt.scatter(masse_finale_reelle, masse_finale_predite_meta, alpha=0.7, color="darkorange")
...
scatter_path = "D:/Mémoire ULB 2024-2025/1 - Avancées Travail Personnel/Machine Learning Final/XGBoost Mf V2/Modèle Conditionnel Test/scatter_reelle_vs_predite_Modele_Conditionnel.png"
...
# Sauvegarde de la figure
scatter_path = "D:/Mémoire ULB 2024-2025/1 - Avancées Travail Personnel/Machine Learning Final/XGBoost Mf V2/Modèle Conditionnel Test/scatter_reelle_vs_predite_Modele_Conditionnel_IC95.png"
plt.savefig(scatter_path, dpi=300)
plt.close()
...
# Sauvegarde de la figure
hist_erreur_path = "D:/Mémoire ULB 2024-2025/1 - Avancées Travail Personnel/Machine Learning Final/XGBoost Mf V2/Modèle Conditionnel Test/hist_erreur_absolue_Modele_Conditionnel.png"
...
# Sauvegarde de la figure
hist_precision_path = "D:/Mémoire ULB 2024-2025/1 - Avancées Travail Personnel/Machine Learning Final/XGBoost Mf V2/Modèle Conditionnel Test/hist_precision_Modele_Conditionnel.png"
...
export_meta_path = "D:/Mémoire ULB 2024-2025/1 - Avancées Travail Personnel/Machine Learning Final/XGBoost Mf V2/Modèle Conditionnel Test/Resultats_Modele_Conditionnel_Test.xlsx"
