...
# Script de modélisation XGBoost pour prédire la dimension a_mm initiale de fruits sphériques à partir de la masse initiale (Masse_tot_g) et du type de fruit (Fruit_Code). Cette fois en excluant le cacao.
# Étapes incluses :
...
export_path = "D:/Mémoire ULB 2024-2025/1 - Avancées Travail Personnel/Machine Learning Final/XGBoost Dimensions V2/Modèle_3/Modèle_3_a_mm"
arbre_path_base = "D:/Mémoire ULB 2024-2025/1 - Avancées Travail Personnel/Machine Learning Final/XGBoost Dimensions V2/Modèle_3/Modèle_3_a_mm"
...
df = df[["Fruit_Code", "ID_Fruit", "Masse_tot_g", "a_mm"]].dropna()
...
optuna_history_path = "D:/Mémoire ULB 2024-2025/1 - Avancées Travail Personnel/Machine Learning Final/XGBoost Dimensions V2/Modèle_3/Modèle_3_a_mm/optuna_evolution_objective.png"
...
joblib.dump(final_model, f"{export_path}/xgboost_modele_final_a.joblib")
...
plt.grid(True)
plt.tight_layout()
cv_evolution_path = "D:/Mémoire ULB 2024-2025/1 - Avancées Travail Personnel/Machine Learning Final/XGBoost Dimensions V2/Modèle_3/Modèle_3_a_mm/evolution_cv_scores.png"
...
evolution_mae_path = "D:/Mémoire ULB 2024-2025/1 - Avancées Travail Personnel/Machine Learning Final/XGBoost Dimensions V2/Modèle_3/Modèle_3_a_mm/evolution_cv_MAE.png"
...
df_train_pred["a_mm_réel"] = y_train.values
df_train_pred["a_mm_prédit"] = y_pred
df_train_pred["Origine"] = "Train"

for col in ["Masse_tot_g", "a_mm"]:
...
df_test_pred["a_mm_réel"] = y_test.values
df_test_pred["a_mm_prédit"] = y_pred_test
...
df_global_pred["Erreur_absolue"] = np.abs(df_global_pred["a_mm_prédit"] - df_global_pred["a_mm_réel"])
df_global_pred["Erreur_relative_%"] = 100 * df_global_pred["Erreur_absolue"] / df_global_pred["a_mm_réel"]
...
df_boot_results["a_mm_prédit_boot"] = mean_preds
...
colonnes_finales = ["Fruit_Code", "ID_Fruit", "Origine",
    "Masse_tot_g_initiale", "a_mm_réel", "a_mm_prédit", "a_mm_prédit_boot",
...
plt.tight_layout()
importance_path = "D:/Mémoire ULB 2024-2025/1 - Avancées Travail Personnel/Machine Learning Final/XGBoost Dimensions V2/Modèle_3/Modèle_3_a_mm/importance_variables.png"
...
min_val = df_global_pred["a_mm_réel"].min()
max_val = df_global_pred["a_mm_réel"].max()
plt.plot([min_val, max_val], [min_val, max_val], 'r--', label="y = x")

plt.xlabel("a réel [mm]")
plt.ylabel("a prédit [mm]")
plt.title("Scatter plot : a réel vs a prédit (Train/Test)")
plt.legend()
plt.tight_layout()
...
for origine, couleur in zip(["Train", "Test"], ["dodgerblue", "darkorange"]):
    ...
    plt.errorbar(
        subset["a_mm_réel"],
        subset["a_mm_prédit_boot"],
        yerr=[
            subset["a_mm_prédit_boot"] - subset["IC_inf"],
            subset["IC_sup"] - subset["a_mm_prédit_boot"]
        ],
        fmt='o',
        color=couleur,
        alpha=0.7,
...
# Sauvegarde de la figure
gain_cumule_path = "D:/Mémoire ULB 2024-2025/1 - Avancées Travail Personnel/Machine Learning Final/XGBoost Dimensions V2/Modèle_3/Modèle_3_a_mm/gain_cumule_par_arbre.png"
plt.savefig(gain_cumule_path)
plt.close()

# Export Excel
with pd.ExcelWriter(f"{export_path}/Resultats_XGBoost_a_mm.xlsx", engine="openpyxl") as writer:
...
print(f"Modèle a_mm et résultats sauvegardés dans : {export_path}")
