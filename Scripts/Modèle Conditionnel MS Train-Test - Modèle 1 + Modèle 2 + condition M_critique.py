...
# La base de données utilisée pour appliquer le modèle conditionnel est la même que celle utilisée pour entraîner les modèles 1 et 2. Elle contient les caractéristiques initiales des fruits amazoniens (masse initiale, dimensions a, b, c) ainsi que leur masse sèche réelle après étuve.
...
# - Évaluation finale (R², RMSE, MAE) spécifique au modèle conditionnel, adapté en fonction du modèle 1 ou 2 considéré, car la prédiction effectuée est différente pour obtenir la masse sèche.
...
df = pd.read_excel("D:/Mémoire ULB 2024-2025/1 - Avancées Travail Personnel/Machine Learning Final/XGBoost MS V2/Modèle 2/Resultats_XGBoost_MS_Modele2_CV.xlsx", sheet_name="Prédictions Train-Test")
...
df_boot_1 = pd.read_excel("D:/Mémoire ULB 2024-2025/1 - Avancées Travail Personnel/Machine Learning Final/XGBoost MS V2/Modèle 1/Resultats_XGBoost_MS_Modele1_CV.xlsx", sheet_name="Prédictions Train-Test")
df_boot_2 = pd.read_excel("D:/Mémoire ULB 2024-2025/1 - Avancées Travail Personnel/Machine Learning Final/XGBoost MS V2/Modèle 2/Resultats_XGBoost_MS_Modele2_CV.xlsx", sheet_name="Prédictions Train-Test")
...
plt.scatter(masse_seche_reelle, masse_seche_predite_meta, alpha=0.7, color="dodgerblue")
...
scatter_path = "D:/Mémoire ULB 2024-2025/1 - Avancées Travail Personnel/Machine Learning Final/XGBoost MS V2/Modèle Conditionnel/scatter_reelle_vs_predite_Modele_Conditionnel.png"
...
plt.plot([masse_seche_reelle.min(), masse_seche_reelle.max()],
         ...
         'r--')
plt.xlabel("Masse sèche réelle [g]")
plt.ylabel("Masse sèche prédite (modèle conditionnel) [g]")
plt.title("Scatter plot : Masse sèche réelle vs prédite\n(Modèle conditionnel)")
plt.annotate(f"M_critique = {M_critique:.3f} g", xy=(0.05, 0.95), xycoords='axes fraction',
...
# Sauvegarde de la figure
scatter_path = "D:/Mémoire ULB 2024-2025/1 - Avancées Travail Personnel/Machine Learning Final/XGBoost MS V2/Modèle Conditionnel/scatter_reelle_vs_predite_Modele_Conditionnel_IC95.png"
plt.savefig(scatter_path, dpi=300)
plt.close()
...
# Sauvegarde de la figure
hist_erreur_path = "D:/Mémoire ULB 2024-2025/1 - Avancées Travail Personnel/Machine Learning Final/XGBoost MS V2/Modèle Conditionnel/hist_erreur_absolue_Modele_Conditionnel.png"
...
# Sauvegarde de la figure
hist_precision_path = "D:/Mémoire ULB 2024-2025/1 - Avancées Travail Personnel/Machine Learning Final/XGBoost MS V2/Modèle Conditionnel/hist_precision_Modele_Conditionnel.png"
...
export_meta_path = "D:/Mémoire ULB 2024-2025/1 - Avancées Travail Personnel/Machine Learning Final/XGBoost MS V2/Modèle Conditionnel/Resultats_Modele_Conditionnel.xlsx"
