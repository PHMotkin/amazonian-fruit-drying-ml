...
# Script XGBoost (Modèle 1) pour prédire la masse sèche de fruits amazoniens à partir de leurs caractéristiques initiales (mi ai bi ci).
# Étapes incluses :
...
arbre_path_base = "D:/Mémoire ULB 2024-2025/1 - Avancées Travail Personnel/Machine Learning Final/XGBoost MS V2/Modèle 1"
...
optuna_history_path = "D:/Mémoire ULB 2024-2025/1 - Avancées Travail Personnel/Machine Learning Final/XGBoost MS V2/Modèle 1/optuna_evolution_objective.png"
...
plt.grid(True)
plt.tight_layout()
cv_evolution_path = "D:/Mémoire ULB 2024-2025/1 - Avancées Travail Personnel/Machine Learning Final/XGBoost MS V2/Modèle 1/evolution_cv_scores.png"
...
evolution_mae_path = "D:/Mémoire ULB 2024-2025/1 - Avancées Travail Personnel/Machine Learning Final/XGBoost MS V2/Modèle 1/evolution_cv_MAE.png"
plt.savefig(evolution_mae_path)
plt.close()

# Sauvegarde du modèle pour de futures usages
modele_path = "D:/Mémoire ULB 2024-2025/1 - Avancées Travail Personnel/Machine Learning Final/XGBoost MS V2/Modèle 1/xgboost_MS_modele_1.joblib"
...
df_train_pred["Masse_sèche_réelle"] = y_train.values
...
df_test_pred["Masse_sèche_réelle"] = y_test.values
...
plt.tight_layout()
importance_path = "D:/Mémoire ULB 2024-2025/1 - Avancées Travail Personnel/Machine Learning Final/XGBoost MS V2/Modèle 1/importance_variables.png"
...
for origine, couleur in zip(["Train", "Test"], ["dodgerblue", "darkorange"]):
    ...
    plt.errorbar(
        ...
        yerr=[
            subset["Masse_sèche_prédite_boot"] - subset["IC_inf"],
...
# Sauvegarde de la figure
gain_cumule_path = "D:/Mémoire ULB 2024-2025/1 - Avancées Travail Personnel/Machine Learning Final/XGBoost MS V2/Modèle 1/gain_cumule_par_arbre.png"
plt.savefig(gain_cumule_path)
plt.close()


# Export du fichier Excel avec les différentes feuilles contenant les données
export_path = "D:/Mémoire ULB 2024-2025/1 - Avancées Travail Personnel/Machine Learning Final/XGBoost MS V2/Modèle 1/Resultats_XGBoost_MS_Modele1_CV.xlsx"
